  ...
  return (
    <Card>
      <ul className="grid grid-cols-1 text-center sm:grid-cols-3">
        ...
        >
          <dt className="text-[32px] font-bold">${dataGoal.backed}</dt>
        ...
        >
          <dt className="text-[32px] font-bold">{dataGoal.totalBackers}</dt>
          <dd className="text-sm text-sonic-silver sm:text-[15px]">
            total backers
          </dd>
        </li>
        <li>
          <dt className="text-[32px] font-bold">{dataGoal.daysLeft}</dt>
          <dd className="text-sm text-sonic-silver sm:text-[15px]">
            days left
          </dd>
        </li>
