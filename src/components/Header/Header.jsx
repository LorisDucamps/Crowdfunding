...
export default function Header() {
    ...
    return (
        <header className="relative flex justify-between items-center max-w-[1440px] mx-auto">
            ...
            <nav className="absolute top-8 left-0 right-0 max-w-[1110px] mx-auto w-full z-20 sm:top-12">
                <div className="flex justify-between px-6">
                    ...
                    <img onClick={() => setIsOpen(!isOpen)} className="z-10 cursor-pointer sm:hidden" src={isOpen ? "/assets/img/close.svg" : "/assets/img/menu.svg"} alt="icon" />
                </div>
            </nav>
            ...
            {isOpen && (
                <nav className="absolute top-[88px] left-0 right-0 px-6 z-20 sm:hidden">
                    <ul className="border border-custom rounded-lg divide-y divide-dark/10 bg-white">
                        <li>
